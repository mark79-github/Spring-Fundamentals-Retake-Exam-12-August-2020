package bg.softuni.gira.constraint;

public class Global {

    public static final String USERNAME_LENGTH_MSG = "Username must be between 3 and 20 characters";
    public static final String NAME_LENGTH_MSG = "Name must be between 3 and 20 characters";
    public static final String PASSWORD_LENGTH_MSG = "Password must be between 3 and 20 characters";
    public static final String CONFIRM_PASSWORD_LENGTH_MSG = "Confirm password must be between 3 and 20 characters";
